...
Generate content for section `section-11-send-emails` (filename: `section-11-send-emails.md`).
...
for `section-11-send-emails` to understand what this section should contain.
...
`/Users/Alphastar/Documents/Code/Spring_2026/email_automation/planning/sections/section-11-send-emails.md`
