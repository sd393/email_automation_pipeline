...
Generate content for section `section-03-lib-observability` (filename: `section-03-lib-observability.md`).
...
for `section-03-lib-observability` to understand what this section should contain.
...
`/Users/Alphastar/Documents/Code/Spring_2026/email_automation/planning/sections/section-03-lib-observability.md`
